...
<html lang="en" dir="ltr">
  ...
  <body>
    <!-- Full Page Intro -->
        <div class="view" style="background-image: url('images/eventsbg.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
              ...
              <div class="row wow fadeIn">
                ...
                <div class="col-md-12 mb-4 white-text text-center wow fadeIn">
                  ...
                  <a href="#!" class="btn btn-rounded btn-outline-white">
                    <i class="far fa-calendar-alt"></i> Add a need
                  </a>
                </div>
                <!--Grid column-->
              </div>
        ...
        <h2 class="text-center mt-5 mb-5 pb-2 text-dark"><strong>Needs by other alumni</strong></h2>
