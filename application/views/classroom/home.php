...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <!-- Full Page Intro -->
      <div class="view" style="background-image: url('images/bg1.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-4 white-text text-center  align-self-center">
                ...
                <a class="btn btn-white wow fadeInDown" data-wow-delay="0.4s">Login</a>
    ...
    <div class="view" style="background-image: url('images/events.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      <!-- Mask & flexbox options-->
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
              ...
              <a class="btn btn-white">Post need</a>
              <a class="btn btn-outline-white">View needs</a>
            </div>
            <!--Grid column-->
            <!--Grid column-->
            <div class="col-md-6 col-xl-5 mt-xl-5 wow fadeInRight" data-wow-delay="0.3s">
              <img src="images/needs.png" alt="" class="img-fluid">
            </div>
            <!--Grid column-->
          </div>
          <!--Grid row-->
        ...
        <div class="container">
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
              ...
              <a class="btn btn-white wow fadeInLeft" data-wow-delay="0.3s">My classroom</a>
            </div>
            <!--Grid column-->
            <!--Grid column-->
            <div class="col-md-6 col-xl-5 mt-xl-5 wow fadeInRight" data-wow-delay="0.3s">
              <br>
              <img src="images/connect_img.png" alt="" class="img-fluid">
            </div>
          </div>
          <!--Grid row-->
        </div>
