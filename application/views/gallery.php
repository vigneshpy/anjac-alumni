...
margin-bottom: 15px;
  ...
  <body>
    ...
    <h2 class="text-center mt-5 mb-5 pb-2 text-dark"><strong>Photos on occasions</strong></h2>
    <div class="container">
    	<div class="row">
    		<div class="row">
                <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                       ...
                       <div class="view overlay">
                          <img src="https://images.pexels.com/photos/853168/pexels-photo-853168.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="img-fluid " alt="smaple image">
